# -*- coding: utf-8 -*-
"""
This micro-service provides the necessary methods for a Certification Authority.
...
class Service(object):
    ...
    def build_CA(self, cert, priv_key, passphrase):
        ...
        Arguments:
            ...
            passphrase: Symmetric key for priv_key decryption.
        """
        ca = CertificationAuthority(cert, priv_key, passphrase)

        # Register object in the Daemon.
        self._pyroDaemon.register(ca)
        return ca
...
ns.register("certificationService.CA", uri)
